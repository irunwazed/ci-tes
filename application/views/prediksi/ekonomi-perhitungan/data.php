                ...
                $jumlahKriteria1 = count($dataEkonomi[0]['dataKriteria']);
                $jumlahRespon1 = count($dataEkonomi[0]['dataRespon']);
                $jumlahKriteriaRespon1 = count($dataEkonomi[0]['dataKriteriaRespon']);
                // echo "<pre>";
                // echo "<div class='row'>";
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Kelayakan Ekonomi</li>
								</ol>
							</nav>
						</div>
					</div>
