...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
					...
					<div class="bg-white pd-20 box-shadow border-radius-5 ">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">AHP</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white pd-20 box-shadow border-radius-5">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">MPE</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-white pd-20 box-shadow border-radius-5">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Finansial</p>
							</div>
						</div>
					</div>
				</div>
			...
			style="background-image: url('<?=base_url()?>public/images/beranda2.png');
			background-repeat: no-repeat;
			background-size: cover;
			height:100%;
			">
				<h4 class="mb-30" style="color: #d4922f">AGRO SEAWEED</h4>
				<div class="row">
					<div class="col-sm-12 col-md-8 col-lg-9 xs-mb-20" style="min-height: 700px">
    ...
    <?=$script?>
	<script src="<?=$baseTemplate?>src/plugins/highcharts-6.0.7/code/highcharts.js"></script>
	<script src="<?=$baseTemplate?>src/plugins/highcharts-6.0.7/code/highcharts-more.js"></script>
